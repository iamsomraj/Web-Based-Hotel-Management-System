...
<body style="background-color:#fcf3c1;">
    ...
    <div></div>
    <div class="container" style="background-color:#fcf3c1;"><?php if(isset($error)) { echo "<p class='message'>".$error."</p>";}?>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            ...
            <div class="form-group">
                <div class="form-row">
                    <div class="col"><input class="form-control form-control-lg" type="text" name="roomtype" value="<? php echo $roomtype;?>" disabled="" readonly="" placeholder="Type of Room"></div>
                </div>
            </div>
            <div class="form-group">
                <div class="form-row">
            ...
            <div class="form-group">
                <div class="form-row">
                    <div class="col"><input class="form-control form-control-lg" type="text" name="noofdays" value="Number Of Days - $noofdays" disabled="" readonly="" placeholder="Number of Days"></div>
                </div>
            </div>
            <div class="form-group">
                <div class="form-row">
            ...
            <div class="form-group">
                <div class="form-row">
                    <div class="col"><select class="form-control form-control-lg" name="pay"><option value="" selected="">Select Payment Method</option><option value="paynow" <?php if(isset($pay) && $pay=="paynow"){echo 'selected="selected"';}?>>Pay Now</option><option value="paylater" <?php if(isset($pay) && $pay=="paylater"){echo 'selected="selected"';}?>>Pay Later</option></select></div>
                </div>
            </div>
            <div class="form-group">
                <div class="form-row">
