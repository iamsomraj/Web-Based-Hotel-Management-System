...
{
	$query = "SELECT * FROM completebooking ORDER BY id";
}
...
if($result)
{
    $output .= '<p class="display-4 text-center text-capitalize text-dark">Complete Booking Table<p>';
