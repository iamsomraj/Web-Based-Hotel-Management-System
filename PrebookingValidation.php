<?php
    ...
    if(isset($_POST['submit'])){
        ...
        else
        {
            ...
            header('location:PostBookingValidation.php');
        }
    }
?>
...
<body style="background-color:#fcf3c1;">
    ...
    <div class="container" style="background-color:#fcf3c1;"><?php if(isset($error)) { echo "<p class='message'>".$error."</p>";}?>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            ...
            <div class="form-group">
                <div class="form-row">
                    <div class="col"><select class="form-control form-control-lg" name="roomtype"><option value="" selected="">Select Room Type</option><option value="biggest" <?php if(isset($roomtype) && $roomtype=="biggest"){echo 'selected="selected"';}?>>Superior - 4 persons</option><option value="big" <?php if(isset($roomtype) && $roomtype=="big"){echo 'selected="selected"';}?>>Deluxe - 3 persons</option><option value="medium" <?php if(isset($roomtype) && $roomtype=="medium"){echo 'selected="selected"';}?>>Semi Deluxe - 2 persons</option><option value="small" <?php if(isset($roomtype) && $roomtype=="small"){echo 'selected="selected"';}?>>Saver - 1 person</option></select></div>
                </div>
            </div>
            <div class="form-group">
                <div class="form-row">
